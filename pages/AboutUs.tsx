        ...
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="relative">
            <div className="aspect-[4/5] rounded-[4rem] overflow-hidden shadow-2xl relative z-10">
              <img
                src="https://www.apple.com/newsroom/images/product/iphone/lifestyle/apple_shot-on-iphone-feb-21_underwood-arrangement-02_02122021_inline.jpg.large_2x.jpg"
                alt="Florist working"
